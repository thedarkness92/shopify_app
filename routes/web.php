...
use App\Http\Controllers\homeProducts;
...
Route::prefix("api")->group(function () {
    Route::get('/products_list', [homeProducts::class, 'index'])->name('products_list');
    Route::get('/products_details/{product_id}', [homeProducts::class, 'show'])->name('product.details');
    Route::get('/cart_details', [CartController::class, 'index'])->name('cart_details');
    Route::post('/cart/add', [CartController::class, 'addToCart'])->name('cart.add');
    Route::get('/get-cart-total', [CartController::class, 'getCartTotal']);
