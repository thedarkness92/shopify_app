...
<head>
    ...
    <!-- Vos balises meta, styles CSS, etc. -->
    <div class="container">
      <div class="row gy-3">
        <!-- Left elements -->
        <style>
        ...
        @endphp
          <h5 class="mb-3"><a href="{{ route('products_list', ['id' =>$shope_id]) }}" class="text-body"><i
...
<body>
    ...
    <p>Prix: {{ $product->variants }}</p>
    Autres détails du produit à afficher -->

    <!-- Autres éléments HTML pour la mise en page des détails du produit -->
    <!-- content -->
<section class="py-5">
  <div class="container">
    <div class="row gx-5">
      ...
      <main class="col-lg-6">
        <div class="ps-lg-3">
          ...
          <div class="mb-3">
            <span class="h5">${{$product->variant}}</span>
          ...
          <div class="row">
            ...
            <dt class="col-3">Hadle</dt>
            <dd class="col-9">{{$product->Hadle}}</dd>

            <dt class="col-3">Vendor</dt>
